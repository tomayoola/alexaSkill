...
module.exports = {
    ...
    callGetSkillCredentials: callGetSkillCredentials,
    // private skill
...
function callGetSkillCredentials(skillId, profile, doDebug, callback) {
    ...
    const headers = {};
    requestWrapper.request('get-skill-credentials', general, headers, null, profile, doDebug, callback);
}
